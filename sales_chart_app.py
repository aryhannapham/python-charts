        ...
        group = BarChartGroup(
            ...
            rods=[
                ...
                BarChartRod(
                    ...
                    width=12,
                    tooltip=f"Living Expenses: ${item['expenses']:,}",
                ),
            ],
    ...
    page.add(
        ...
        ft.Container(
            content=ft.Row(
                [
                    ft.Text(
                        f"Total Tuition: ${totals['sales']:,}",
                        size=16,
                        weight=ft.FontWeight.W_500,
                        color=ft.Colors.BLUE_700,
                    ),
                    ft.Text(
                        f"Total Living Expenses: ${totals['expenses']:,}",
                        size=16,
                        weight=ft.FontWeight.W_500,
                        color=ft.Colors.RED_700,
                    ),
                    ft.Text(
                        f"Total Spending: ${totals['profit']:,}",
                        size=16,
                        weight=ft.FontWeight.W_500,
